...
foreach ([
    "ALTER TABLE `settings` ADD COLUMN `description` TEXT DEFAULT NULL AFTER `value`",
    "ALTER TABLE `settings` ADD COLUMN `effective_from` DATE DEFAULT NULL AFTER `description`",
    "ALTER TABLE `settings` ADD COLUMN `requires_approval` TINYINT(1) NOT NULL DEFAULT 0 AFTER `effective_from`"
] as $alterSql) {
