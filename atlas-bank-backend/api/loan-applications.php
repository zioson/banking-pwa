...
function laEnsureSchema(PDO $db): void {
 ...
 laAddCol($db, 'loan_applications', 'interest_rate', "DECIMAL(10,2);
 laAddCol($db, 'loan_applications', 'product_type', "VARCHAR(50);
 laAddCol($db, 'loan_applications', 'repayment_mode', "VARCHAR(30);
 laAddCol($db, 'loan_applications', 'repayment_amount', "DECIMAL(20,2);
 laAddCol($db, 'loan_applications', 'repayment_pct', "DECIMAL(10,4);
 laAddCol($db, 'loan_applications', 'auto_deduct', "SMALLINT;
 laAddCol($db, 'loan_applications', 'interest_included', "SMALLINT;
 laAddCol($db, 'loan_applications', 'loan_module', "VARCHAR(30);
 laAddCol($db, 'loan_applications', 'insurance_fee', "DECIMAL(20,2);
 laAddCol($db, 'loan_applications', 'requires_double_approval', "SMALLINT;
 laAddCol($db, 'loan_applications', 'debit_account_number', "VARCHAR(30);
 ...
 laAddCol($db, 'loan_applications', 'guarantor_account_number', "VARCHAR(30);
...
switch ($method) {
 ...
 ORDER BY CASE WHEN status = 'ACTIVE' THEN 1WHEN status = 'DELINQUENT' THEN 2WHEN status = 'WRITTEN_OFF' THEN 3WHEN status = 'DEFAULTED' THEN 4 ELSE 0 END
 LIMIT 1"
 );
